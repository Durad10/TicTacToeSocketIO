...
class ViewController: UIViewController, UIAlertViewDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        btn4.addTarget(self, action: #selector(btnClicked(btn:)), for: .touchUpInside)
        btn5.addTarget(self, action: #selector(btnClicked(btn:)), for: .touchUpInside)
        btn6.addTarget(self, action: #selector(btnClicked(btn:)), for: .touchUpInside)
        btn7.addTarget(self, action: #selector(btnClicked(btn:)), for: .touchUpInside)
        btn8.addTarget(self, action: #selector(btnClicked(btn:)), for: .touchUpInside)
    ...
    func promptUserOnDevice() {
        let url: URL = URL(string: "http://10.132.146.107:8900")!
